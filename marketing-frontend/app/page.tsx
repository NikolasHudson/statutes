			...
			<div className="relative mx-auto max-w-7xl px-5 sm:px-8">
				<div className="border-[#393939] border-b py-20 lg:py-28">
					...
					{/* Three stacked lines from sm up: comma / "every" / close. Below sm
					    it wraps naturally, with "within reach" bound. */}
					<h1 className="mt-8 font-light text-4xl leading-[1.1] sm:text-5xl lg:text-[4.25rem]">
						Serious legal research, <br className="hidden sm:block" />
						within&nbsp;reach of every <br className="hidden sm:block" />
						practicing attorney.
					</h1>
