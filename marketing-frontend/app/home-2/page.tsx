// Marketing home, take two ("/home-2") — the Carbon (IBM design system) home:
// editorial ink bands alternating with light ones, hairline rules instead of
// cards, Plex-light display type, square Blue-60 actions. The hero speaks for
// the company; the flagship product gets the entire first band, anchored by a
// real screenshot. Chrome + primitives live in components/marketing/carbon.tsx
// (shared by all Carbon pages); the legacy home stays at "/" until this one is
// promoted.
...
const SPECS: { term: string; detail: string }[] = [
	...
	{ term: "Access", detail: "Web · MCP · API" },
];
...
const CAPABILITIES: { title: string; body: string }[] = [
	...
	},
	{
		...
		body: "Available in the browser and over MCP, so the same grounded research runs inside the tools you already use.",
	},
];
			...
			<div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
				...
				<figure className="mt-16 border border-border bg-card">
					...
					<img
						...
						alt="Hudson Corpus answering an Iowa consumer-fraud question with verified statutory citations"
						className="w-full"
					/>
				</figure>
...
const DISCIPLINES: {
...
}[] = [
	{
		tag: "Products",
		title: "Hudson Corpus",
		body: "Grounded legal research for practitioners — Iowa Code, court rules, and caselaw in one system, with citations verified against the effective text. Live in beta.",
