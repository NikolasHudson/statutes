...
const defaultComponents = memoizeMarkdownComponents({
  ...
  a: ({ className, href, ...props }) => {
    // Same-origin / relative links (e.g. /browse#/iowa-code/714.16) open
    // in the same tab so the SPA can handle the navigation. External
    // links (legis.iowa.gov etc.) open in a new tab.
    const isInternal =
      !!href &&
      (href.startsWith("/") ||
        href.startsWith("#") ||
