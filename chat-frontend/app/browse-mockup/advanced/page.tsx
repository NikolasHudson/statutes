...
// Design mockup for a full-page Advanced Search — the classic research-tool
// fielded search builder (Westlaw/Lexis style), lifted out of the cramped
// dropdown panel into its own route (/browse-mockup/advanced). Dense by design:
// universal term boxes (all/any/phrase/exclude) over a content-type-aware field
// grid, date + jurisdiction filters, and a connectors/tips rail. Submitting
// compiles the form into the live /browse search params so it actually runs
// against the corpus; fields the backend doesn't model yet fold into the query
// as plain terms.
...
export default function AdvancedSearchMockupPage() {
