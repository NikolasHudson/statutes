...
// Library home — the search-first entry to the corpus, wired to the live
// /api/browse/sources counts. Design from /browse-carbon-mockup; a search
// routes to /results, a source opens its index (chapters for statutes,
						...
						<div className="divide-y divide-[var(--cds-border)] border border-[var(--cds-border)]">
							{shown.map((s) => {
								...
								return (
									<Link
										key={s.slug}
										href={`/source/${encodeURIComponent(s.slug)}`}
