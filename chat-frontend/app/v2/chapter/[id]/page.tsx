...
// v2 chapter view — /api/browse/chapters/<id>: the chapter's heading and its
// section list, each row opening the v2 section reader.
	...
	return (
		<div className="px-5 py-10 sm:px-8 lg:py-14">
			<nav className="text-sm">
				...
				<Link
					href={`/v2/source/${chapter.source_slug}`}
					className="text-[var(--cds-text-2)] hover:text-[var(--cds-link)] hover:underline"
				>
